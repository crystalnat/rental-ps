...
import { Store, TrendingUp } from 'lucide-vue-next'
...
function selectStore(storeId: number) {
    router.get('/admin/cashflow', { store: storeId })
}
</script>

<template>
    <AdminLayout title="Cashflow">
        <div class="flex min-h-[50dvh] items-center justify-center">
            <Card class="w-full max-w-md">
                <CardHeader>
                    ...
                    <CardDescription>
                        Pilih toko untuk melihat arus kas (pemasukan & pengeluaran).
                    </CardDescription>
                </CardHeader>
                <CardContent>
