                        ...
                        <table class="w-full text-sm [&_td]:align-middle">
                            ...
                            <tbody :key="`page-${orders.current_page}`">
                                ...
                                >
                                    ...
                                    <td class="hidden align-middle px-4 py-3 text-sm text-muted-foreground md:table-cell">{{ order.created_at }}</td>
                                    <td class="hidden align-middle whitespace-nowrap px-4 py-3 sm:table-cell">
                                        <span
                                    ...
                                    <td class="hidden align-middle px-4 py-3 text-muted-foreground lg:table-cell">{{ order.table_name ?? '—' }}</td>
                                    <td class="hidden align-middle px-4 py-3 lg:table-cell">{{ order.customer_name ?? '—' }}</td>
                                    <td class="hidden align-middle px-4 py-3 text-muted-foreground xl:table-cell">{{ order.cashier_name ?? '—' }}</td>
                                    <td class="hidden align-middle px-4 py-3 text-center font-medium md:table-cell">{{ order.item_count }}</td>
                                    <td class="align-middle px-4 py-3">
                                        <span
                                            class="inline-flex rounded-full border px-2.5 py-0.5 text-xs font-medium whitespace-nowrap"
